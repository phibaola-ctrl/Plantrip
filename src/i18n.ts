  ...
  vi: {
    translation: {
      ...
      itinerary: {
        ...
        loadingBudget: "ĐANG TÍNH TOÁN NGÂN SÁCH...",
        ratingLabel: "ĐÁNH GIÁ",
        budgetAnalyzerTitle: "PHÂN TÍCH NGÂN SÁCH AI",
        budgetAnalyzerSub: "QUẢN LÝ TÀI CHÍNH THÔNG MINH CHO HÀNH TRÌNH CỦA BẠN",
        totalBudget: "TỔNG NGÂN SÁCH",
        groupEstimate: "ƯỚC TÍNH CHO TOUR",
        perPersonDay: "CHI PHÍ / NGƯỜI / NGÀY",
        marketPriceLabel: "GIÁ ƯỚC TÍNH THEO THỊ TRƯỜNG",
